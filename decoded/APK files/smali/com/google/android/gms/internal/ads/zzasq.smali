...
# instance fields
.field private zzdqn:Landroid/content/Context;

.field private zzdqo:Ljava/lang/ref/WeakReference;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/internal/ads/zzasq;->zzdqo:Ljava/lang/ref/WeakReference;
...
.method private final declared-synchronized zzd(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    .line 18
    :try_start_0
    iget-object v0, p0, Lcom/google/android/gms/internal/ads/zzasq;->zzdqn:Landroid/content/Context;
    ...
    iget-object v1, p0, Lcom/google/android/gms/internal/ads/zzasq;->zzdqn:Landroid/content/Context;
...
.method private final declared-synchronized zze(Landroid/content/Intent;)V
    ...
    .line 25
    :try_start_0
    iget-object v0, p0, Lcom/google/android/gms/internal/ads/zzasq;->zzdqo:Ljava/lang/ref/WeakReference;
...
.method public static zzv(Landroid/content/Context;)Lcom/google/android/gms/internal/ads/zzasq;
    .locals 1

    .line 39
    new-instance v0, Lcom/google/android/gms/internal/ads/zzasq;

    invoke-static {p0}, Lcom/google/android/gms/internal/ads/zzasq;->zzk(Landroid/content/Context;)Landroid/content/Context;

    move-result-object p0

    invoke-direct {v0, p0}, Lcom/google/android/gms/internal/ads/zzasq;-><init>(Landroid/content/Context;)V

    return-object v0
.end method

.method public static zzw(Landroid/content/Context;)Landroid/content/Context;
    .locals 1

    .line 40
    instance-of v0, p0, Lcom/google/android/gms/internal/ads/zzasq;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/ads/zzasq;->getBaseContext()Landroid/content/Context;
...
.method public final declared-synchronized setAppPackageName(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/internal/ads/zzasq;->zzdqn:Landroid/content/Context;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized startActivity(Landroid/content/Intent;)V
    ...
    .line 16
    :try_start_0
    invoke-direct {p0, p1}, Lcom/google/android/gms/internal/ads/zzasq;->zzd(Landroid/content/Intent;)Landroid/content/Intent;

    move-result-object p1

    invoke-direct {p0, p1}, Lcom/google/android/gms/internal/ads/zzasq;->zze(Landroid/content/Intent;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
